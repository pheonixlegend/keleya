...
import { Text, View, StyleSheet, TextInput, DatePickerIOS} from 'react-native';
    ...
    <View>
      ...
      <View style={styles.centeredView}>
        ...
        <TextInput
          ...
          style={[styles.input, screenType == "nameScreen" ? { display: 'none' } 
          : { display: 'flex' }]}
        /> 
        ...
        <DatePickerIOS
          ...
          style={[screenType == "dateScreen" ? { display: 'flex' } 
          : { display: 'none' }]}
        />
