...
interface Props {
  screenType: string;
  handleCallbackEmail: boolean;
  handleCallbackPassword: boolean;
}

const LoginSignupDetails: FC<Props> = ({ screenType, handleCallbackEmail, handleCallbackPassword }) => {
