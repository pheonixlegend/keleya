...
import { Text, View, StyleSheet, TextInput, Platform, Dimensions} from 'react-native';
    ...
    <View>
      ...
      <View style={styles.centeredView}>
        <Text style={[styles.subText, screenType == "workoutScreen" ? { display: 'none' } 
            : { display: 'flex' }]}>
          {[styles.subText, screenType == "nameScreen" ? 
...
const styles = StyleSheet.create({
  ...
  subText: {
    textAlign: 'center',
    marginTop: height * 0.01, //105%
    fontSize: height * 0.025, //26
    width: '90%',
    fontWeight: "300",
    color: "#4a4a4a",
    paddingBottom: '10%'
