      ...
      <View style={styles.centeredView}>
        ...
        <View style={styles.checkboxView}>
          <CheckBox
            ...
            size={26}
            containerStyle ={{backgroundColor: 'transparent', borderColor: 'transparent', margin: 0, padding: 0}}
          />
          <CheckBox
            title="I accept the terms & conditions and Keleya's advice"
            uncheckedColor='#9adcd7'
            size={26}
            containerStyle ={{backgroundColor: 'gray', borderColor: 'transparent', margin: 0, padding: 0}}
          />
        </View>
