...
function SignUp() {
  ...
  function handleCallbackEmail (emailData: String) {
    setEmailValidated(emailData)
  }

  function handleCallbackPassword (passwordData: String) {
 ...
 return (
    <SafeAreaView style={styles.mainContainer}>
      ...
      <ImageHeader/>
      <LoginSignupDetails screenType = "signUpScreen" EmailCallBack = {handleCallbackEmail} PasswordCallBack = {handleCallbackPassword} />
     
      <View style={styles.buttonContainer}>
          <TouchableOpacity style={styles.customBtnBGBottom} onPress={() => navigation.navigate('Name')}>
