...
function SignUp() {
 ...
 return (
    <SafeAreaView style={styles.mainContainer}>
      ...
      <Text style={styles.customBtnTextBottom}>{!EmailValidated && !PasswordValidated}</Text>
          <TouchableOpacity disabled={!EmailValidated && !PasswordValidated} style={styles.customBtnBGBottom} onPress={() => navigation.navigate('Name')}>
