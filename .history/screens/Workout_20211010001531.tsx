...
type nameScreenProp = StackNavigationProp<RootStackParamList, 'Workout'>;
...
function Workout() {
 ...
 return (
    <SafeAreaView style={styles.mainContainer}>
      ...
      {<NameTimeDetails screenType = "workoutScreen" /> }
     
      <View style={styles.buttonContainer}>
          <TouchableOpacity style={styles.customBtnBGBottom} onPress={() => navigation.navigate('Workout')}>
