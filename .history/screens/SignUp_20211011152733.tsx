...
function SignUp() {
 ...
 return (
    <SafeAreaView style={styles.mainContainer}>
      ...
      <Text style={styles.customBtnTextBottom2}>{EmailValidated.toString() + ' ' + PasswordValidated.toString()}</Text>
      <View style={styles.buttonContainer}>
      
          <TouchableOpacity style={[styles.customBtnBGBottom, EmailValidated == true ? { backgroundColor: "#69c0ba"} : { backgroundColor: "#9b9b9b"}]}
